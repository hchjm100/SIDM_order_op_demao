#!/bin/bash -l
#
#SBATCH --output=GadgetSIDM1_run2.out     # Standard output and error log
#
#SBATCH --nodes=1               # Number of nodes
#SBATCH --ntasks=64              # Total MPI tasks (matching mpirun -np #)
...
#SBATCH --job-name="2noncomov_demao"
...
mpirun -np 64 ./GadgetSIDM1 run2.param
