...
#define MAX_NGB             60000  /*!< defines maximum length of neighbour list */
...
extern struct global_data_all_processes
{
  ...
  int BunchSizeSIDM;            /*!< number of particles fitting into the communication buffer in the SIDM computation */
...
extern struct particle_data
{
  ...
  int Type;		        /*!< flags particle type.  0=gas, 1=chi1 (default halo), 2=chi2 (default disk), 3=bulge, 4=stars, 5=bndry */
...
extern struct sidmdata_in
{
  ...
  FLOAT Mass;
//  FLOAT OldAcc; 
//  FLOAT tPos[3]; // position of the target
//  FLOAT tVel[3]; // velocity of the target
//  int Ti_endstep;               /*!< marks start of current timestep of particle on integer timeline */ 
//  int Ti_begstep;               /*!< marks end of current timestep of particle on integer timeline */
  int tscatt;
  int Type;
  int sendTask; // The PE which send this particle
  int Task;     // Targeting PE of this particle
  int Index;
//#ifndef LONGIDS
//  unsigned int ID;              /*!< particle identifier */
//#else
 ...
 *SIDMDataIn,                   /*!< holds particle data to be exported to other processors */
 *SIDMDataGet,                  /*!< holds particle data imported from other processors */
 *SIDMDataOut,                  /*!< holds partial results received from other processors. This will overwrite the GravDataIn array */
 *SIDMDataResult;               /*!< stores the locally computed SIDM results for imported particles */
 //*SIDMDataPartialResult;        /*!< imported partial SIDM results from other processors */

//extern int N_DM;		/*!< number of DM particles on the LOCAL processor  */
extern FLOAT Velmin[3], Velmax[3], VelminGlobal[3], VelmaxGlobal[3];
